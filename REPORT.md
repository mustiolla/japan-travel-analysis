...
*(대응 코드: `analysis.ipynb [Cell #19]` / `run_analysis.py [L148-L158]`)*
* **관찰(Fact):** 연중 **1월과 2월의 방문객 중앙값(Median)이 압도적 최상위**를 기록한 반면, **9월은 연중 최비수기**로 나타남.
* **해석(Why):** 1~2월은 겨울 방학과 연말연시/설 연휴가 겹치는 전통적 온천·눈축제 피크 시즌이며, 9월은 바캉스 직후이자 태풍 시즌으로 인해 계절적 수요가 급감함.
* **행동 및 예상 KPI (Action):** 9월 최비수기에는 파격적인 얼리버드 할인 및 좌석 소진(Fill-up) 프로모션을 진행. **(예상 KPI: 9월 비수기 탑승률 +10%p 방어)**

---

### 🔎 심층 분석 1: 경제 원리를 무너뜨린 6대 역사적 충격 (Black Swan)

**1. 주요 역사적 사건 전후 수치 비교 표**
| 사건명 | 발생 시점 | 직전 6개월 평균 | 직후 6개월 평균 | 방문객 증감률 | 경제 공식 작동 여부 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **동일본 대지진 / 원전** | 2011년 03월 | 214,594명 (환율 13.8원) | **104,638명** (환율 13.4원) | **-51.2%** | **붕괴** (환율 하락에도 반토막 급락) |
| **일본 불매운동 (No Japan)** | 2019년 07월 | 643,776명 (환율 10.4원) | **286,990명** (환율 10.9원) | **-55.4%** | **붕괴** (소폭 환율 상승 대비 55% 급락) |
...
* **관찰(Fact):** 정상기에는 음수($r < 0$)에 머물던 롤링 상관계수가 6대 사건(2011 동일본 대지진, 2014 세월호 애도, 2016 구마모토 지진, 2019 노재팬, 2020 팬데믹, 2024 지진 우려) 시점에 **양수($r > 0$)로 치솟으며 관계가 완전히 붕괴**됨.
* **결론:** 생명 안전 위협 및 외교 갈등 상황에서는 저환율이라는 경제적 유인이 완전히 무력화됨.
